const submitBtn = document.querySelector('.submit-btn'),
    ...
    signInLink = 'https://member.finbudd.com/sign_in?post_login_redirect=https%3A%2F%2Fmember.finbudd.com%2F#email';
...
submitBtn.addEventListener('click', (e) => {
    e.preventDefault();
    if (count > 5) {
        // Redirect to the sign-in page with the provided link
